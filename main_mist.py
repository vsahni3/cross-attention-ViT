...
params_list = [
    Params(lr=1e-4, drop=0.1, sched_type='train_loss', patience=25, factor=0.05, weight_decay=1e-3, img_types=("DWI", "T1c"), label_smoothing=0.1),
    ...
    Params(lr=1e-4, drop=0.1, sched_type='val_loss', patience=25, factor=0.25, weight_decay=1e-3, img_types=("DWI", "T1c"), label_smoothing=0.1)
]
